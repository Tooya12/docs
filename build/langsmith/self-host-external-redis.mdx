...
<Info>
We now support Redis Cluster for LangSmith as of helm version **0.12.25**. You can find the helm values to configure [here](https://link_to_helm_values.com), and an example configuration [here](https://link_to_example_file_here.com)
</Info>
